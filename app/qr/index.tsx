		...
		<View style={styles.root}>
			...
			<View style={StyleSheet.absoluteFill}>
				...
				<Svg style={StyleSheet.absoluteFill} width="100%" height="100%">
					<Defs>
						<RadialGradient id="b1" cx="10%" cy="12%" rx="45%" ry="40%">
						...
						<RadialGradient id="b2" cx="90%" cy="8%" rx="38%" ry="32%">
					...
					<Rect x="0" y="0" width="100%" height="100%" fill="url(#b4)" />
					<Rect x="0" y="0" width="100%" height="100%" fill="url(#b5)" />
					<Rect x="0" y="0" width="100%" height="100%" fill="url(#b6)" />
				</Svg>
				<Image
